 ...
 *
 * The OpenAPI specification is automatically generated by Elysia from:
 * - Route schemas (body, query, params, response)
 * - Route metadata (tags, summary, description)
 *
 * Alternative: Visit /api/openapi for Scalar UI (built into Elysia)
 *
 * @page /api-docs
 * @access Public
 */
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <div className="flex gap-4 text-muted-foreground text-sm">
            ...
            <span>•</span>
            <span>Automatically generated from Elysia route schemas</span>
          </div>
        </div>
