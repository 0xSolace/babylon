...
import type {
  PredictionMarketFromSchema,
  UserPredictionPosition as SharedUserPredictionPosition,
} from '@babylon/shared';
...
export type {
  ...
  // Schema-inferred types for API data
  PerpMarketFromSchema,
  PerpPosition,
  PositionUpdate,
  PredictionMarketFromSchema,
  PredictionPosition,
...
type PredictionMarket = PredictionMarketFromSchema;
...
// NOTE: For runtime validation schemas (PerpMarketSchema, PredictionMarketSchema),
// import directly from '@babylon/shared' where needed

// =============================================================================
// Market Types - Using schema-inferred types from @babylon/shared
// =============================================================================

/**
 * PerpMarket and PredictionMarket types from API.
 *
 * These types are inferred from Zod schemas in @babylon/shared for consistency.
 * Use PerpMarketSchema/PredictionMarketSchema from @babylon/shared for runtime validation.
 */
export type {
  PerpMarketFromSchema as PerpMarket,
  PredictionMarketFromSchema as PredictionMarket,
} from '@babylon/shared';
 ...
 */
export type PredictionMarketWithPosition = PredictionMarket & {
