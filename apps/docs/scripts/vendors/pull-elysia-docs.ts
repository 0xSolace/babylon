 ...
 *
 * Strategy:
 * - Read the public VitePress hashmap at https://elysiajs.com/hashmap.json
 ...
 *
 * Usage:
 *   bun run apps/docs/scripts/vendors/pull-elysia-docs.ts [--output docs/vendors/elysia]
 */
...
const DEFAULT_OUTPUT = 'docs/vendors/elysia'
...
export async function pullElysiaDocs(options: Options = opts) {
