 ...
 *
 * Strategy:
 * - Read sitemap.xml at https://bun.com/docs/sitemap.xml
 ...
 * - Write to a local output folder, preserving structure.
 *
 * Usage:
 *   bun run apps/docs/scripts/vendors/pull-bun-docs.ts [--output docs/vendors/bun] [--workers 16]
 */
...
const DEFAULT_OUTPUT = 'docs/vendors/bun'
...
export async function pullBunDocs(options: Options = opts) {
