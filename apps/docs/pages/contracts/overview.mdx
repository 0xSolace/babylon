...
**Address**: See [Deployed Contracts](/contracts/deployed-contracts)
...
See [full deployment addresses →](/contracts/deployed-contracts)
...
- [Deployed Contracts](/contracts/deployed-contracts) - View all contract addresses and ABIs

### Solidity Interfaces

```solidity
// Import in your contracts
import "@jejunetwork/contracts/interfaces/IIdentityRegistry.sol";
import "@jejunetwork/contracts/interfaces/IReputationSystem.sol";
```
...
- [Deployed Contracts](/contracts/deployed-contracts) - View all contract addresses
