...
Waitlist Mark API POST /api/waitlist/mark Marks an existing user as waitlisted (after they complete onboarding) NOTE: Users should complete onboarding first via /api/users/signup with isWaitlist flag
