...
1. Check `JEJU_OAUTH3_SERVICE_URL` is set correctly
2. Verify `BABYLON_OAUTH3_APP_ID` matches your app registration
3. Ensure callback URLs match your domain configuration
