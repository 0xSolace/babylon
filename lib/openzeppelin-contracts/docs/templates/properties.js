...
module.exports.inheritance = ({ item, build }) => {
...
module.exports['has-functions'] = ({ item }) =>
  item.inheritance.some((c) => c.functions.length > 0);

module.exports['has-events'] = ({ item }) => item.inheritance.some((c) => c.events.length > 0);

module.exports['has-errors'] = ({ item }) => item.inheritance.some((c) => c.errors.length > 0);

module.exports['internal-variables'] = ({ item }) =>
  item.variables.filter(({ visibility }) => visibility === 'internal');

module.exports['has-internal-variables'] = ({ item }) =>
  module.exports['internal-variables']({ item }).length > 0;

module.exports.functions = ({ item }) => [
...
module.exports['inherited-functions'] = ({ item }) => {
