...
describe('Base58', () => {
  ...
  describe('base58', () => {
    describe('encode/decode random buffers', () => {
      ...
      for (const length of [0, 1, 2, 3, 4, 32, 42, 128, 384])
        it(
          [length > 32 && '[skip-on-coverage]', `buffer of length ${length}`]
            .filter(Boolean)
            .join(' '),
          async function () {
