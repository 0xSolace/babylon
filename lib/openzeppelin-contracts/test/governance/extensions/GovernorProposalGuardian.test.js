...
describe('GovernorProposalGuardian', () => {
  for (const { Token, mode } of TOKENS) {
    const fixture = async () => {
      const [owner, proposer, guardian, voter1, voter2, voter3, voter4, other] =
    ...
    describe(`using ${Token}`, () => {
      ...
      describe('set proposal guardian', () => {
      ...
      describe('cancel proposal during active state', () => {
        beforeEach(async function () {
          await this.helper.connect(this.proposer).propose();
