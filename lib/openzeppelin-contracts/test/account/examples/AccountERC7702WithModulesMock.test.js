...
async function fixture() {
  ...
  const mock = await helper.newAccount(
    ...
    ['AccountERC7702WithModulesMock', '1'],
    {
      erc7702signer: eoa,
    }
  );
...
describe('AccountERC7702WithModules: ERC-7702 account with ERC-7579 modules supports', () => {
  beforeEach(async function () {
    Object.assign(this, await loadFixture(fixture));
  });

  describe('using ERC-7702 signer', () => {
    beforeEach(async function () {
  ...
  describe('using ERC-7579 validator', () => {
    beforeEach(async function () {
      ...
      this.userOp = {
        nonce: ethers.zeroPadBytes(ethers.hexlify(this.validator.target), 32),
      };
      ...
      await this.mock
        .connect(this.eoa)
        .installModule(MODULE_TYPE_VALIDATOR, this.validator, this.signer.address);
    });
