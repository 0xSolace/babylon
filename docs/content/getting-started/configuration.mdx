...
# OAuth3 Authentication (Jeju)
JEJU_OAUTH3_SERVICE_URL="http://localhost:4020"
...
#### OAuth3 Configuration (Jeju)

1. Configure your Jeju OAuth3 service
2. Set up allowed origins:
...
3. Supported authentication methods:
   ...
   - Farcaster (optional)
   - Twitter (optional)
4. Copy your OAuth3 service URL and App ID to `.env.local`
...
### OAuth3 Authentication Fails

- Verify `JEJU_OAUTH3_SERVICE_URL` is correct
