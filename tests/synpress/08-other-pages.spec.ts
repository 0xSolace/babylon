...
test.describe('Leaderboard Page', () => {
  ...
  test('should load leaderboard page', async ({ page }) => {
    ...
    await page.screenshot({
      path: 'test-results/screenshots/08-leaderboard.png',
      fullPage: true,
    });
  ...
  test('should display leaderboard rankings', async ({ page }) => {
    ...
    const hasRankings = await isVisible(
      page,
      'text=/rank|#1|#2|position/i',
      5000
    );
  ...
  test('should display user profiles in leaderboard', async ({ page }) => {
    ...
    const hasProfiles = await isVisible(
      page,
  ...
  test('should display user stats/scores', async ({ page }) => {
    ...
    const hasScores = await isVisible(
      page,
      'text=/points|score|balance/i',
      5000
    );
  ...
  test('should filter leaderboard by period', async ({ page }) => {
    const tabs = page.locator(
      'button[role="tab"], button:has-text("Daily"), button:has-text("Weekly"), button:has-text("Monthly")'
    );
...
test.describe('Referrals Page', () => {
  ...
  test('should load referrals page', async ({ page }) => {
    ...
    await page.screenshot({
      path: 'test-results/screenshots/08-referrals.png',
      fullPage: true,
    });
  ...
  test('should display referral code', async ({ page }) => {
    ...
    const hasCode = await isVisible(
      page,
      'code, [data-testid="referral-code"], text=/code|invite/i',
      5000
    );

    await page.screenshot({
      path: 'test-results/screenshots/08-referral-code.png',
    });
  ...
  test('should copy referral link', async ({ page }) => {
    ...
    if (await copyButton.isVisible({ timeout: 5000 }).catch(() => false)) {
      ...
      await page.screenshot({
        path: 'test-results/screenshots/08-referral-copied.png',
      });
  ...
  test('should display referral stats', async ({ page }) => {
    ...
    const hasStats = await isVisible(
      page,
      'text=/referred|invites|earnings|rewards/i',
      5000
    );
  ...
  test('should display referred users list', async ({ page }) => {
    ...
    const hasUserList = await isVisible(
      page,
      'text=/your referrals|people you invited/i',
      5000
    );
...
test.describe('Rewards Page', () => {
  ...
  test('should load rewards page', async ({ page }) => {
    ...
    await page.screenshot({
      path: 'test-results/screenshots/08-rewards.png',
      fullPage: true,
    });
  ...
  test('should display total rewards/points', async ({ page }) => {
    ...
    const hasRewards = await isVisible(
      page,
      'text=/points|rewards|balance/i',
      5000
    );
  ...
  test('should display rewards breakdown', async ({ page }) => {
    ...
    const hasBreakdown = await isVisible(
      page,
      'text=/earned|trading|referrals|bonus/i',
      5000
    );
  ...
  test('should display rewards history', async ({ page }) => {
    ...
    const hasHistory = await isVisible(
      page,
      'text=/history|transactions|activity/i',
      5000
    );
...
test.describe('Registry Page', () => {
  ...
  test('should load registry page', async ({ page }) => {
    ...
    await page.screenshot({
      path: 'test-results/screenshots/08-registry.png',
      fullPage: true,
    });
  ...
  test('should display registered agents/users', async ({ page }) => {
    ...
    const hasEntries = await isVisible(
      page,
      '[data-testid="registry-entry"], article, [data-testid="agent-card"]',
      5000
    );
  ...
  test('should search registry', async ({ page }) => {
    ...
    if (await searchInput.isVisible({ timeout: 5000 }).catch(() => false)) {
      ...
      await page.screenshot({
        path: 'test-results/screenshots/08-registry-search.png',
      });
...
test.describe('API Documentation Page', () => {
  ...
  test('should load API documentation page', async ({ page }) => {
    ...
    await page.screenshot({
      path: 'test-results/screenshots/08-api-docs.png',
      fullPage: true,
    });
  ...
  test('should display API endpoints', async ({ page }) => {
    ...
    const hasEndpoints = await isVisible(
      page,
      'text=/GET|POST|PUT|DELETE|endpoint/i',
      5000
    );
  ...
  test('should display endpoint documentation', async ({ page }) => {
    ...
    const hasDocumentation = await isVisible(
      page,
      'text=/parameters|response|request|example/i',
      5000
    );
  ...
  test('should expand/collapse endpoint details', async ({ page }) => {
    ...
    const expandButton = page
      .locator(
        'button:has-text("GET"), button:has-text("POST"), [data-testid="endpoint"]'
      )
      .first();
    ...
    if (await expandButton.isVisible({ timeout: 5000 }).catch(() => false)) {
      ...
      await page.screenshot({
        path: 'test-results/screenshots/08-api-endpoint-expanded.png',
      });
...
test.describe('Settings Page', () => {
  ...
  test('should load settings page', async ({ page }) => {
    ...
    await page.screenshot({
      path: 'test-results/screenshots/08-settings.png',
      fullPage: true,
    });
  ...
  test('should display settings sections', async ({ page }) => {
    ...
    const hasSettings = await isVisible(
      page,
      'text=/profile|privacy|notifications|preferences/i',
      5000
    );
  ...
  test('should toggle theme', async ({ page }) => {
    const themeToggle = page
      .locator('button[aria-label*="theme" i], [data-testid="theme-toggle"]')
      .first();
    ...
    if (await themeToggle.isVisible({ timeout: 5000 }).catch(() => false)) {
      ...
      await page.screenshot({
        path: 'test-results/screenshots/08-theme-toggled.png',
      });
  ...
  test('should display notification settings', async ({ page }) => {
    ...
    const hasNotificationSettings = await isVisible(
      page,
      'text=/notification|email|push/i',
      5000
    );

    console.log(
      `✅ Notification settings displayed: ${hasNotificationSettings}`
    );
  });
});
...
test.describe('Notifications Page', () => {
  ...
  test('should load notifications page', async ({ page }) => {
    ...
    await page.screenshot({
      path: 'test-results/screenshots/08-notifications.png',
      fullPage: true,
    });
  ...
  test('should display notifications list', async ({ page }) => {
    ...
    const hasNotifications = await isVisible(
      page,
      '[data-testid="notification"], article, [role="listitem"]',
      5000
    );
  ...
  test('should display empty state if no notifications', async ({ page }) => {
    ...
    const hasEmptyState = await isVisible(
      page,
      'text=/no notifications|all caught up/i',
      5000
    );
...
test.describe('Game Page', () => {
  ...
  test('should load game page', async ({ page }) => {
    ...
    await page.screenshot({
      path: 'test-results/screenshots/08-game.png',
      fullPage: true,
    });
  ...
  test('should display game state', async ({ page }) => {
    ...
    const hasGameState = await isVisible(
      page,
      'text=/round|day|phase|status/i',
      5000
    );
  ...
  test('should display game players/actors', async ({ page }) => {
    ...
    const hasActors = await isVisible(
      page,
      '[data-testid="actor"], [data-testid="player"], img[alt*="avatar" i]',
      5000
    );
  ...
  test('should display game events', async ({ page }) => {
    ...
    const hasEvents = await isVisible(
      page,
      'text=/event|happened|news/i',
      5000
    );
