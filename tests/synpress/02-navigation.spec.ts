...
test.describe('Navigation - Authenticated', () => {
  ...
  test('should navigate to Feed page', async ({ page }) => {
    ...
    await page.screenshot({
      path: 'test-results/screenshots/02-feed-page.png',
    });
  ...
  test('should navigate to Game page', async ({ page }) => {
    ...
    await page.screenshot({
      path: 'test-results/screenshots/02-game-page.png',
    });
  ...
  test('should navigate to Markets page', async ({ page }) => {
    ...
    await page.screenshot({
      path: 'test-results/screenshots/02-markets-page.png',
    });
  ...
  test('should navigate to Leaderboard page', async ({ page }) => {
    ...
    await page.screenshot({
      path: 'test-results/screenshots/02-leaderboard-page.png',
    });
  ...
  test('should navigate to Profile page', async ({ page }) => {
    ...
    await page.screenshot({
      path: 'test-results/screenshots/02-profile-page.png',
    });
  ...
  test('should navigate to Settings page', async ({ page }) => {
    ...
    await page.screenshot({
      path: 'test-results/screenshots/02-settings-page.png',
    });
  ...
  test('should navigate to Chats page', async ({ page }) => {
    ...
    await page.screenshot({
      path: 'test-results/screenshots/02-chats-page.png',
    });
  ...
  test('should navigate to Notifications page', async ({ page }) => {
    ...
    await page.screenshot({
      path: 'test-results/screenshots/02-notifications-page.png',
    });
  ...
  test('should navigate to Referrals page', async ({ page }) => {
    ...
    await page.screenshot({
      path: 'test-results/screenshots/02-referrals-page.png',
    });
  ...
  test('should navigate to Rewards page', async ({ page }) => {
    ...
    await page.screenshot({
      path: 'test-results/screenshots/02-rewards-page.png',
    });
  ...
  test('should navigate to Registry page', async ({ page }) => {
    ...
    await page.screenshot({
      path: 'test-results/screenshots/02-registry-page.png',
    });
  ...
  test('should navigate to API Docs page', async ({ page }) => {
    ...
    await page.screenshot({
      path: 'test-results/screenshots/02-api-docs-page.png',
    });
...
test.describe('Navigation - Sidebar Links', () => {
  ...
  test('should have working sidebar navigation links', async ({ page }) => {
    ...
    const sidebarVisible = await isVisible(
      page,
      'aside, nav[aria-label*="sidebar" i]'
    );
    ...
    if (sidebarVisible) {
      ...
      const navLinks = await page
        .locator('aside a, nav[aria-label*="sidebar" i] a')
        .all();
...
test.describe('Navigation - Mobile Bottom Nav', () => {
  ...
  test('should have working bottom navigation on mobile', async ({ page }) => {
    ...
    const bottomNavVisible = await isVisible(
      page,
      'nav[aria-label*="bottom" i], [data-testid="bottom-nav"]'
    );
    ...
    if (bottomNavVisible) {
      ...
      await page.screenshot({
        path: 'test-results/screenshots/02-mobile-bottom-nav.png',
      });

      // Get all bottom nav buttons/links
      const navButtons = await page
        .locator(
          'nav[aria-label*="bottom" i] button, nav[aria-label*="bottom" i] a, [data-testid="bottom-nav"] button, [data-testid="bottom-nav"] a'
        )
        .all();
