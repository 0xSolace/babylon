...
test.describe('Rewards System - Unauthenticated', () => {
  test('should show login prompt on rewards page when not authenticated', async ({
    page,
  }) => {
  ...
  test('should accept referral code in URL query parameter', async ({
    page,
  }) => {
...
test.describe('Rewards System - Authenticated User Flow', () => {
  ...
  test('should display tips section for users with few referrals', async ({
    page,
  }) => {
    await page.goto('/rewards');
    await page.waitForLoadState('networkidle');
...
test.describe('Rewards System - Navigation', () => {
  ...
  test('should navigate to rewards from sidebar', async ({ page }) => {
    ...
    if (await rewardsLink.isVisible()) {
      ...
      await expect(
        page.getByRole('heading', { name: 'Rewards' })
      ).toBeVisible();
    }
  });
  ...
  test('should highlight rewards nav item when on rewards page', async ({
    page,
  }) => {
    await page.goto('/rewards');
    await page.waitForLoadState('networkidle');
...
test.describe('Rewards System - Stats Cards', () => {
  ...
  test('should calculate and display points earned correctly', async ({
    page,
  }) => {
    await page.goto('/rewards');
