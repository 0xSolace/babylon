...
test.describe('Referral System - Complete Integration Flow', () => {
  test.skip('should complete full referral flow from generation to signup', async ({
    page,
    context,
  }) => {
  ...
  test.skip('should handle invalid referral codes gracefully', async ({
    page,
  }) => {
    // Test that:
...
test.describe('Referral System - API Endpoints', () => {
  ...
  test('should generate referral code via API', async ({ request }) => {
    ...
    const response = await request.get(
      `${BASE_URL}/api/users/test-user-id/referral-code`,
      {
        headers: {
  ...
  test('should fetch referral stats via API', async ({ request }) => {
    ...
    const response = await request.get(
      `${BASE_URL}/api/users/test-user-id/referrals`,
      {
        headers: {
          Authorization: `Bearer ${mockToken}`,
        },
  ...
  test('should require authentication for referral endpoints', async ({
    request,
  }) => {
  ...
  test('should validate user access to their own referrals only', async ({
    request,
  }) => {
    ...
    const response = await request.get(
      `${BASE_URL}/api/users/different-user-id/referrals`,
      {
        headers: {
          Authorization: `Bearer ${mockToken}`,
        },
...
test.describe('Referral System - Points Award', () => {
  test.skip('should award exactly 250 points per referral', async ({
    request,
  }) => {
    // This test requires:
...
test.describe('Referral System - Auto-Follow', () => {
  test.skip('should create Follow relationship on signup', async ({
    request,
  }) => {
  ...
  test.skip('should show follow status correctly in referrals list', async ({
    page,
  }) => {
