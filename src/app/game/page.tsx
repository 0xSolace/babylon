  ...
  return (
    <PageContainer className="overflow-y-auto pb-24 md:pb-4">
      <div className="mx-auto max-w-feed space-y-4 px-4 pt-4">
        {/* Engine Status Card */}
        <div className={cn('rounded-2xl border border-border bg-card p-6', 'shadow-md')}>
          <div className="mb-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <Activity
                className={cn(
                  'h-4 w-4',
                  engineStatus?.isRunning ? 'animate-pulse text-green-500' : 'text-muted-foreground'
                )}
              />
              <span
                className={cn(
          ...
          <div className="space-y-2">
            <div>
              <div className="mb-1 text-muted-foreground text-xs">Current Game Date</div>
        ...
        <div className={cn('rounded-2xl border border-border bg-card p-6', 'shadow-md')}>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div>
              <div className="mb-1 text-muted-foreground text-xs">Total Posts</div>
              <div className="font-bold text-2xl" style={{ color: '#0066FF' }}>
                {stats?.totalPosts?.toLocaleString() || '0'}
              </div>
            </div>
            <div>
              <div className="mb-1 text-muted-foreground text-xs">Active Questions</div>
              <div className="font-bold text-2xl" style={{ color: '#0066FF' }}>
                {stats?.activeQuestions || '0'}
              </div>
            </div>
            <div>
              <div className="mb-1 text-muted-foreground text-xs">Companies</div>
              <div className="font-bold text-2xl" style={{ color: '#0066FF' }}>
        ...
        <div className={cn('rounded-2xl border border-border bg-card p-6', 'shadow-md')}>
          ...
          <div className="space-y-2 text-muted-foreground text-sm">
            <p>
              The continuous game engine runs in real-time, generating 10-20 posts per minute and
              updating markets automatically.
            </p>
            <p>
              Posts appear in the <span className="font-medium text-foreground">Home</span> feed as
