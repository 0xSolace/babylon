                  ...
                  <article className="px-4 py-4 sm:px-6 sm:py-5">
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-muted-foreground text-sm">
                                This article shows {post.biasScore > 0 ? 'favorable' : 'critical'}{' '}
                                bias.
                    ...
                    <div className="prose prose-lg prose-invert mb-6 max-w-none">
                      {post.fullContent.split('\n\n').map((paragraph) => (
                        <p
                          key={`post-${post.id}-paragraph-${paragraph.slice(0, 40)}`}
            ...
            {post.type === 'article' && post.fullContent && post.fullContent.length > 100 ? (
              ...
              <article className="px-4 py-4 sm:px-6 sm:py-5">
                ...
                <div className="prose prose-invert mb-4 max-w-none">
                  {post.fullContent.split('\n\n').map((paragraph) => (
                    <p
                      key={`post-mobile-${post.id}-paragraph-${paragraph.slice(0, 40)}`}
