              ...
              <article className="px-4 py-4 sm:px-6 sm:py-5">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-muted-foreground text-sm">
                            This article shows {article.biasScore > 0 ? 'favorable' : 'critical'}{' '}
                            bias.
                ...
                <div className="prose prose-lg prose-invert mb-6 max-w-none">
                  {(article.fullContent || article.content).split('\n\n').map((paragraph) => (
                    <p
                      key={`${article.id}-paragraph-${paragraph.slice(0, 40)}`}
        ...
        <div className="flex-1 overflow-y-auto">
          <article className="px-4 py-4 sm:px-6 sm:py-5">
              ...
              Math.abs(article.biasScore) >= 0.3 && (
                <div className="mb-4 rounded-lg border border-yellow-500/20 bg-yellow-500/10 p-3">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <p className="mb-1 font-semibold text-xs text-yellow-500">Biased Coverage</p>
            ...
            <div className="prose prose-invert mb-4 max-w-none">
              {(article.fullContent || article.content).split('\n\n').map((paragraph) => (
                <p
                  key={`${article.id}-paragraph-mobile-${paragraph.slice(0, 40)}`}
