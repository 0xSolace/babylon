...
export default function ProfilePage() {
  ...
  useEffect(() => {
    ...
    const loadContent = async () => {
      ...
      const response = await fetch(`/api/users/${encodeURIComponent(user.id)}/posts?type=${tab}`, {
        headers,
      });
      if (response.ok) {
                    ...
                    {user.hasTwitter && user.twitterUsername && (
                      <div className="group flex items-center justify-between">
                        ...
                        >
                          ...
                          {socialVisibility.twitter && <ExternalLink className="h-3 w-3" />}
                        </a>
                        <button
                          type="button"
                    ...
                    {user.hasFarcaster && user.farcasterUsername && (
                      <div className="group flex items-center justify-between">
                        ...
                        >
                          ...
                          {socialVisibility.farcaster && <ExternalLink className="h-3 w-3" />}
                        </a>
                        <button
                          type="button"
                  ...
                  <div className="space-y-2">
                    {posts.map((item) => {
                      ...
                      const authorName =
                        ...
                        user?.username ||
                        'You';
                      const authorUsername = item.author?.username || user?.username || undefined;
                      const authorImage =
                      ...
                      <div className="absolute inset-0 flex items-center justify-center bg-black/40">
                        ...
                        >
                          ...
                          <span className="font-medium text-xs sm:text-sm">
                            {editModal.coverImage.preview || editModal.formData.coverImageUrl
                              ? 'Change'
                              : 'Add'}{' '}
                            cover
                          </span>
                      ...
                      <div>
                        ...
                        <div className="flex min-h-[44px] items-center gap-2 rounded-lg border border-border bg-muted/50 px-4 py-3 focus-within:border-border">
                          ...
                          <input
                            ...
                            disabled={
                              editModal.isSaving ||
                              Boolean(usernameChangeLimit && !usernameChangeLimit.canChange)
                            }
                          />
                        </div>
                      </div>
