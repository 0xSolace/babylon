        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="font-medium text-sm">Overall Health</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="flex items-center gap-2">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-6">
              ...
              <div>
                <div className="font-bold text-2xl">{stats.database.queries.slow}</div>
                <div className="text-muted-foreground text-xs">Slow Queries</div>
              </div>
              <div>
                <div className="font-bold text-2xl">
            ...
            {stats.database.topSlowQueries.length > 0 && (
              <div>
                ...
                <div className="space-y-2">
                  {stats.database.topSlowQueries.map((query) => (
                    <div
                      key={`${query.query}-${query.count}`}
                      className="flex items-center justify-between border-b pb-2 text-sm"
                    >
                      <div className="flex-1">
                        <div className="font-mono">{query.query}</div>
                        <div className="text-muted-foreground text-xs">Count: {query.count}</div>
                      </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          {loadTestStatus?.status === 'running' ? (
            ...
            <>
              <div>
                <label htmlFor="load-test-scenario" className="mb-2 block font-medium text-sm">
                  Select Scenario
                </label>
                <select
                  id="load-test-scenario"
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 text-sm md:grid-cols-4">
                ...
                <div>
                  ...
                  <div className="text-muted-foreground text-xs">Completed At</div>
                </div>
              </div>
            </div>
          )}
