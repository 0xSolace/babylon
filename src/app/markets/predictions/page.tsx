...
export default function PredictionsPage() {
  ...
  const { predictionPositions, refresh: refreshUserPositions } = useUserPositions(user?.id, {
    ...
    try {
      ...
      setSparklineData((prev) => {
        ...
        fetchedPredictions.forEach((prediction) => {
          ...
          const yesProbability = totalShares > 0 ? (prediction.yesShares || 0) / totalShares : 0.5;
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex items-center justify-between gap-3 text-xs">
                    <div className="flex gap-3 text-muted-foreground">
                      <div className="flex items-center gap-1" title={timeInfo.exact || undefined}>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex flex-col text-right">
                        <span className="font-medium text-green-600">{yesPrice}% YES</span>
