...
export default function PerpDetailLoading() {
  const statsPlaceholders = ['stat-total', 'stat-volume', 'stat-leverage', 'stat-liquidation'];
  ...
  const positionPlaceholders = ['position-A', 'position-B', 'position-C'];
