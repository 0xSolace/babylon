...
export const POST = withErrorHandling(
  async (request: NextRequest, context: { params: Promise<{ id: string }> }) => {
    ...
    const {
      ...
      if (market.resolved) {
        throw new BusinessLogicError('Cannot sell from resolved market', 'MARKET_RESOLVED', {
          marketId,
        });
      }
      ...
      const netProceeds = calculation.netProceeds ?? calculation.totalCost; // Net proceeds after fee
