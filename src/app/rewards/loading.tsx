...
const rewardSkeletonKeys = ['reward-1', 'reward-2', 'reward-3', 'reward-4', 'reward-5'];
    ...
    <PageContainer>
      <div className="mx-auto w-full max-w-4xl space-y-6">
        ...
        <div className="space-y-3">
          {rewardSkeletonKeys.map((key) => (
            <div key={key} className="rounded-lg border border-border bg-card/50 p-4 backdrop-blur">
