...
export default function LeaderboardPage() {
  ...
  const activeTabDescription = tabs.find((tab) => tab.key === selectedTab)?.description || '';
    ...
    <PageContainer noPadding className="flex flex-col">
      ...
      <div className="hidden flex-1 flex-col overflow-hidden sm:flex">
        <div className="mx-auto w-full max-w-feed px-4 pt-6 lg:px-6">
          ...
          <p className="mt-3 text-muted-foreground text-sm">{activeTabDescription}</p>
        </div>
          ...
          <div className="flex flex-1 items-center justify-center p-8">
            <div className="text-center text-muted-foreground">
              ...
              {leaderboardData.pointsCategory === 'all' && (
                <>
                  ...
                  <p className="mb-2 text-sm">
                    Earn {baseMinPoints.toLocaleString()} reputation points to appear on the
                    leaderboard!
                  </p>
                  <p className="text-xs">
                    Complete your profile, link socials, share, and refer friends to earn up to
                    7,000 points
                  </p>
                </>
              )}
              {leaderboardData.pointsCategory === 'earned' && (
                <>
                  <p className="mb-2 font-semibold text-foreground text-lg">No Earned Points Yet</p>
                  <p className="text-sm">
                  ...
                  return (
                    <Link
                      ...
                      className={`block px-4 py-3 transition-colors ${
                        isCurrentUser ? 'border-l-4 bg-[#0066FF]/20' : 'hover:bg-muted/30'
                      }`}
                      style={{
                        ...
                        (player.invitePoints > 0 ||
                          ...
                          <div className="mt-2 ml-16 flex gap-4 text-xs">
                            <div className="flex items-center gap-1">
                              ...
                              <span className={`font-semibold ${pnlColor}`}>{pnlDisplay}</span>
                            </div>
                            {player.invitePoints > 0 && (
                              <div className="flex items-center gap-1">
      ...
      <div className="flex flex-1 flex-col overflow-hidden sm:hidden">
        <div className="w-full px-4 pt-4 sm:px-6">
          ...
          <p className="mt-2 text-muted-foreground text-xs">{activeTabDescription}</p>
        </div>
