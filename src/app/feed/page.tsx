...
function FeedPageContent() {
  ...
  const calculateBannerInterval = () => {
    ...
    if (lastDismiss) {
      const daysSinceDismiss = (Date.now() - parseInt(lastDismiss, 10)) / 86400000;
  ...
  const fetchLatestPosts = useCallback(
    async (requestCursor: string | null, append = false, skipLoadingState = false) => {
              ...
              {tab === 'trades' ? (
                ...
                <div className="w-full p-4 text-center sm:p-8">
                  <div className="py-8 text-muted-foreground sm:py-12">
                    ...
                    <p className="mb-4 text-sm sm:text-base">Engine is generating posts...</p>
                ...
                <div className="w-full space-y-0">
                  {basePosts.map((post, i: number) => {
                    ...
                    const postData = {
                      ...
                      originalPostId:
                        ('originalPostId' in post ? post.originalPostId : null) || null,
                      originalAuthorId:
                        ('originalAuthorId' in post ? post.originalAuthorId : null) || null,
                      originalAuthorName:
                        ('originalAuthorName' in post ? post.originalAuthorName : null) || null,
                      originalAuthorUsername:
                        ('originalAuthorUsername' in post ? post.originalAuthorUsername : null) ||
                        null,
                      originalAuthorProfileImageUrl:
                        ('originalAuthorProfileImageUrl' in post
                          ? post.originalAuthorProfileImageUrl
                          : null) || null,
                      originalContent:
                        ('originalContent' in post ? post.originalContent : null) || null,
