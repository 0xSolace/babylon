...
export function CommentCard({
  ...
  return (
    <div className={cn('flex gap-3', depth > 0 && 'ml-8 border-border border-l-2 pl-4', className)}>
      {/* Avatar - Round */}
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="mb-2 flex items-center justify-between gap-2">
          <div className="flex min-w-0 flex-1 items-center gap-2">
            <span className="truncate font-semibold text-sm">{comment.userName}</span>
        ...
        {comment.parentCommentId && comment.parentCommentAuthorName && (
          <div className="mb-1 flex items-center gap-1 text-muted-foreground text-xs">
            ...
            <span className="font-medium text-primary">@{comment.parentCommentAuthorName}</span>
          </div>
        )}
