...
type GroupInviteNotificationProps = {
  inviteId: string;
  groupName: string;
  ...
  return (
    <div className="rounded-lg border border-border bg-sidebar p-4 shadow-sm">
      <div className="flex items-start gap-3">
        <Avatar imageUrl={inviterImage || undefined} name={inviterName} size="md" />
        ...
        <div className="min-w-0 flex-1 space-y-3">
          <div>
            ...
            {groupDescription && (
              <p className="mb-2 line-clamp-2 text-muted-foreground text-sm">{groupDescription}</p>
            )}
