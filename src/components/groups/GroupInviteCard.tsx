      ...
      <div className="rounded-lg border border-green-500/20 bg-green-500/10 p-4 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-muted-foreground text-xs">You are now a member of {groupName}</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="space-y-3">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            {groupDescription && (
              <p className="mb-2 line-clamp-2 text-muted-foreground text-xs">{groupDescription}</p>
            )}
