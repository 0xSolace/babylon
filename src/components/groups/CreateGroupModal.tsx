      ...
      <div className="relative w-full max-w-md rounded-xl border border-border bg-background shadow-2xl">
        ...
        <div className="p-6">
          ...
          <div className="space-y-4">
            {/* Group Name (Optional) */}
            <div>
              <label htmlFor="groupName" className="mb-2 block font-medium text-sm">
                Group Name{' '}
            ...
            {selectedUsers.length > 0 && (
              <div className="space-y-2">
                <p className="block font-medium text-sm">Members ({selectedUsers.length})</p>
            ...
            {/* User Search */}
            <div>
              <label htmlFor="create-group-search" className="mb-2 block font-medium text-sm">
                Add Members
              </label>
            ...
            {!searchQuery && selectedUsers.length === 0 && (
              <div className="rounded-lg border border-border border-dashed bg-sidebar py-4 text-center text-muted-foreground text-sm">
                ...
                <p className="mt-1 text-xs">Group name will auto-generate if not specified</p>
              </div>
            )}
          </div>
