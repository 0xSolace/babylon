        ...
        return (
          <>
            <div className="space-y-4">
              ...
              <div>
                <label htmlFor="admin-amount-input" className="mb-2 block font-medium text-sm">
                  Amount (USD)
                </label>
                ...
                <p className="mt-1 text-muted-foreground text-xs">Min: $0.01 • Max: $10,000</p>
              </div>

              <div>
                <label htmlFor="admin-reason-input" className="mb-2 block font-medium text-sm">
                  Reason (optional)
                </label>
                <textarea
      ...
      case 'error':
        return (
          <div className="py-8 text-center">
            ...
            <p className="mb-2 font-semibold text-lg text-red-600">Payment Failed</p>
