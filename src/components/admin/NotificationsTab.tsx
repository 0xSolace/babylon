...
type UserInfoResponse = { user?: { id?: string } };
type NotificationResponse = {
  ...
  details?: unknown;
  chatId?: string;
  participantRecords?: Array<Record<string, unknown>>;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4 rounded-lg border border-border bg-card p-6">
        {/* Recipient Type */}
        <div>
          <p className="mb-2 block font-medium text-sm">Recipient</p>
        ...
        <div>
          ...
          <textarea
            ...
            disabled={isSending}
          />
          <p className="mt-1 text-muted-foreground text-xs">{message.length}/500 characters</p>
        </div>
        ...
        <button
          ...
          onClick={handleSend}
          disabled={
            isSending || !message.trim() || (recipientType === 'specific' && !userId.trim())
          }
          className={cn(
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-4 rounded-lg border border-border bg-card p-6">
          {/* Sender User ID */}
          <div>
            <label htmlFor="dmSenderId" className="mb-2 block font-medium text-sm">
              Sender User ID
            </label>
            <input
              id="dmSenderId"
          ...
          {/* Recipient User ID */}
          <div>
            <label htmlFor="dmRecipientId" className="mb-2 block font-medium text-sm">
              Recipient User ID
            </label>
            <div className="flex gap-2">
              <input
            ...
            <p className="mt-1 text-muted-foreground text-xs">
              Click &quot;Use My ID&quot; to use your logged-in account (blockchain_b0ss), or
              &quot;Welcome Bot&quot; for the test user
            </p>
          </div>
        ...
        <div className="rounded-lg border border-blue-500/20 bg-blue-500/10 p-4">
          <p className="text-blue-600 text-sm dark:text-blue-400">
            ℹ️ <strong>Note:</strong> This will create or use an existing DM chat between the two
            users and send 100 numbered test messages. Perfect for testing pagination when scrolling
            up in the chat.
          </p>
        </div>
        ...
        <div className="space-y-3 rounded-lg border border-border bg-muted/50 p-4">
          ...
          <ol className="list-inside list-decimal space-y-2 text-muted-foreground text-sm">
            <li>
              <strong>Easiest:</strong> Click &quot;Use My ID&quot; button to test with your own
              account!
            </li>
            <li>
              <strong>Or use Welcome Bot:</strong> Click &quot;Welcome Bot&quot; to use the default
              test user
            </li>
            <li>
              <strong>Find other IDs:</strong> Go to the &quot;Users&quot; tab above to see all user
              IDs
            </li>
          </ol>
          ...
          <div className="mt-3 rounded-lg border border-yellow-500/20 bg-yellow-500/10 p-3">
            <p className="text-xs text-yellow-600 dark:text-yellow-400">
              ⚠️ <strong>Important:</strong> You need the <strong>user ID</strong> (long string like
              &quot;cm3x7y8z9...&quot;), not the username. The &quot;Use My ID&quot; button handles
              this automatically!
            </p>
          </div>

          <div className="mt-3 border-border border-t pt-3">
            <h4 className="mb-2 font-semibold text-xs">Default Test Users (auto-seeded):</h4>
            <ul className="space-y-1 text-muted-foreground text-xs">
              ...
              <li className="flex items-center gap-2">
                <code className="rounded bg-muted px-2 py-1 font-mono">demo-user-welcome-bot</code>
...
function GroupInviteSection() {
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-muted-foreground text-sm">
        Send a group chat invite to a user on behalf of an NPC. This will add the user to the
        NPC&apos;s group chat.
      </p>
      ...
      <div className="space-y-4 rounded-lg border border-border bg-card p-6">
        ...
        {/* User ID */}
        <div>
          <label htmlFor="inviteUserId" className="mb-2 block font-medium text-sm">
            User ID (Invitee) *
          </label>
          <input
            id="inviteUserId"
      ...
      <div className="space-y-2 rounded-lg border border-blue-500/20 bg-blue-500/10 p-4">
        <h3 className="font-semibold text-blue-600 text-sm dark:text-blue-400">How it works:</h3>
