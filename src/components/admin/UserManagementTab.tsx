    ...
    return (
      <div className="rounded-2xl border border-border bg-card p-4 transition-colors hover:border-primary/50">
        <div className="flex items-start gap-4">
          ...
          <Avatar src={user.profileImageUrl || undefined} alt={displayName} size="md" />
          ...
          <div className="min-w-0 flex-1 space-y-2">
            ...
            {/* Wallet Address */}
            {user.walletAddress && (
              <div className="font-mono text-muted-foreground text-xs">{user.walletAddress}</div>
            )}
            ...
            {user.isBanned && user.bannedReason && (
              <div className="rounded border border-red-500/20 bg-red-500/10 p-2 text-sm">
                ...
                <div className="text-muted-foreground text-xs">{user.bannedReason}</div>
                {user.bannedAt && (
      ...
      {showBanModal && selectedUser && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-md rounded-2xl border border-border bg-card p-6">
            ...
            <div className="mb-4">
              <label htmlFor="user-ban-reason" className="mb-2 block font-medium text-sm">
