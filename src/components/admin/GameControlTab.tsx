    ...
    return (
      <div className="rounded-lg border border-border bg-card p-4 transition-shadow hover:shadow-md">
        <div className="mb-2 flex items-start justify-between">
          <div className={cn('rounded-lg p-2', colorClasses[color].split(' ')[1])}>
        ...
        {subValue && <div className="mt-1 text-muted-foreground text-xs">{subValue}</div>}
      </div>
    );
  };
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-border bg-gradient-to-br from-card to-accent/20 p-6">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className={cn(
                ...
                autoRefresh ? 'bg-green-500/20 text-green-500' : 'bg-gray-500/20 text-gray-500'
              )}
            >
        ...
        <div className="mt-4 grid grid-cols-2 gap-4 border-border border-t pt-4 md:grid-cols-4">
          ...
          <div>
            <div className="mb-1 text-muted-foreground text-xs">Total Ticks</div>
      ...
      <div>
        ...
        <div className="rounded-lg border border-orange-500/20 bg-gradient-to-br from-orange-500/10 to-red-500/10 p-6">
          <div className="grid grid-cols-2 gap-6 md:grid-cols-4">
            <div>
              <div className="mb-1 text-muted-foreground text-sm">Total Calls</div>
              <div className="font-bold text-2xl">{formatNumber(llmStats.totalCalls24h)}</div>
            </div>
            <div>
              <div className="mb-1 text-muted-foreground text-sm">Prompt Tokens</div>
              <div className="font-bold text-2xl">
                {formatNumber(llmStats.totalPromptTokens24h)}
              </div>
            </div>
            <div>
              <div className="mb-1 text-muted-foreground text-sm">Completion Tokens</div>
              <div className="font-bold text-2xl">
                {formatNumber(llmStats.totalCompletionTokens24h)}
              </div>
            </div>
            <div>
              <div className="mb-1 text-muted-foreground text-sm">Avg Latency</div>
              <div className="font-bold text-2xl">
                {llmStats.avgLatencyMs24h !== null ? `${llmStats.avgLatencyMs24h}ms` : 'N/A'}
              </div>
            </div>
          </div>
        </div>
