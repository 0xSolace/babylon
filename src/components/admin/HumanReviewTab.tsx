    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Appeals that require human review after staking $10. Review carefully and decide whether
          to restore the account or confirm permanent ban.
        </p>
      </div>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mb-4">
                    <div className="mb-1 text-muted-foreground text-sm">Ban Reason</div>
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-2xl border border-border bg-card p-6">
        ...
        <div className="mb-4">
          <label htmlFor="human-review-decision" className="mb-2 block font-medium text-sm">
            Decision
          </label>
          <select
        ...
        <div className="mb-4">
          <label htmlFor="human-review-reasoning" className="mb-2 block font-medium text-sm">
            Reasoning
          </label>
          <textarea
            id="human-review-reasoning"
            value={reasoning}
