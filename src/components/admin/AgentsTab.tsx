...
export function AgentsTab() {
  ...
  const [sortBy, setSortBy] = useState<'reputation' | 'pnl' | 'trades' | 'winRate' | 'name'>(
    'reputation'
  );
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
          ...
          <div className="rounded-lg border border-green-500/20 bg-card/50 p-6 backdrop-blur">
            <div className="mb-2 flex items-center justify-between">
              ...
              <span className="font-bold text-2xl text-green-500">{stats.running}</span>
            </div>
          ...
          <div className="rounded-lg border border-yellow-500/20 bg-card/50 p-6 backdrop-blur">
            <div className="mb-2 flex items-center justify-between">
              ...
              <span className="font-bold text-2xl text-yellow-500">{stats.paused}</span>
            </div>
          ...
          <div className="rounded-lg border border-red-500/20 bg-card/50 p-6 backdrop-blur">
            <div className="mb-2 flex items-center justify-between">
              ...
              <span className="font-bold text-2xl text-red-500">{stats.error}</span>
            </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm md:grid-cols-6">
                    ...
                    <div>
                      <div className="mb-1 text-muted-foreground text-xs">Points</div>
                    ...
                    <div>
                      <div className="mb-1 text-muted-foreground text-xs">Trades</div>
                      <div className="font-mono text-xs">{agent.totalTrades}</div>
                    </div>
                    <div>
                      <div className="mb-1 text-muted-foreground text-xs">Win Rate</div>
