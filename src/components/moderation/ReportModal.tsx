...
export function ReportModal({
  ...
  const handleReport = () => {
    ...
    startReporting(async () => {
      ...
      if (!response.ok) {
        let parsedError: { message?: string } | undefined;
        try {
        ...
        toast.error(parsedError?.message || 'Failed to submit report');
        return;
      }
      ...
      <div className="my-8 w-full max-w-2xl rounded-2xl border border-border bg-card p-6">
        ...
        <div className="mb-6 flex items-center gap-3 rounded-lg bg-muted/50 p-3">
          ...
          <div>
            ...
            {targetUsername && (
              <div className="text-muted-foreground text-sm">@{targetUsername}</div>
            )}
          </div>
        </div>
        ...
        <div className="mb-4 flex gap-3 rounded-lg border border-orange-500/20 bg-orange-500/10 p-3">
          ...
          <div className="text-sm">
            ...
            <p className="text-muted-foreground">
              Filing false reports may result in your account being restricted. Only report content
        ...
        {/* Reason */}
        <div className="mb-4">
          <label htmlFor="report-reason" className="mb-2 block font-medium text-sm">
        ...
        {/* Evidence URL */}
        <div className="mb-6">
          <label htmlFor="report-evidence" className="mb-2 block font-medium text-sm">
            Evidence (optional)
          </label>
          <input
            id="report-evidence"
