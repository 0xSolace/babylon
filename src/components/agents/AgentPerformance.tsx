      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        {stats.map((stat) => (
          ...
          >
            ...
            <div className={cn('font-bold text-2xl', stat.color)}>{stat.value}</div>
          </div>
        ))}
      </div>
      ...
      <div className="rounded-lg border border-border bg-card/50 p-6 backdrop-blur">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between rounded-lg bg-muted/30 p-3 transition-all hover:bg-muted/50">
            ...
            <span className="font-semibold text-red-600">{totalTrades - profitableTrades}</span>
          </div>
      ...
      <div className="rounded-lg border border-border bg-card/50 p-6 backdrop-blur">
        ...
        {totalTrades === 0 ? (
          <div className="py-8 text-center text-muted-foreground">
            ...
            <p className="mt-2 text-sm">Enable autonomous mode to start trading</p>
          </div>
        ) : (
          <div className="space-y-3">
            <div className="rounded-lg bg-muted/30 p-4 transition-all hover:bg-muted/50">
              <div className="mb-2 text-muted-foreground text-sm">Performance</div>
