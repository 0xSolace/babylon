    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        <div className="rounded-lg border border-border bg-card/50 p-6 backdrop-blur">
          <div className="mb-2 text-muted-foreground text-sm">Agent Balance</div>
          <div className="mb-4 font-bold text-3xl">{agent.pointsBalance} pts</div>
        ...
        <div className="rounded-lg border border-border bg-card/50 p-6 backdrop-blur">
          ...
          <p className="text-muted-foreground text-sm">Available for deposit to agents</p>
        </div>
      </div>
            ...
            {transactions.map((tx) => (
              ...
              >
                <div className="flex-1">
                  ...
                  <div className="text-muted-foreground text-sm">{tx.description}</div>
