...
export function AgentSettings({ agent, onUpdate }: AgentSettingsProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    personality:
      agent.personality || (Array.isArray(agent.bio) ? agent.bio.filter((b) => b).join('\n') : ''),
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        const error = (await res.json().catch(() => ({ error: 'Failed to update agent' }))) as {
          error?: string;
        };
    ...
    <div className="space-y-6">
      <div className="rounded-lg border border-border bg-card/50 p-6 backdrop-blur">
        ...
        <div className="space-y-4">
          <div>
            <label htmlFor="agent-name" className="mb-2 block font-medium text-sm">
              Name
            </label>
            <Input
              id="agent-name"
          ...
          <div>
            <label htmlFor="agent-description" className="mb-2 block font-medium text-sm">
              Description
            </label>
            <Textarea
          ...
          <div>
            <label htmlFor="agent-profile-image-url" className="mb-2 block font-medium text-sm">
              Profile Image URL
            </label>
            <Input
              id="agent-profile-image-url"
      ...
      <div className="rounded-lg border border-border bg-card/50 p-6 backdrop-blur">
        ...
        <div className="space-y-4">
          <div>
            <label htmlFor="agent-important-directions" className="mb-2 block font-medium text-sm">
              Important Directions
            </label>
            <Textarea
              id="agent-important-directions"
          ...
          <div>
            <label htmlFor="agent-personality" className="mb-2 block font-medium text-sm">
          ...
          <div>
            <label htmlFor="agent-trading-strategy" className="mb-2 block font-medium text-sm">
              Trading Strategy
            </label>
            <Textarea
              id="agent-trading-strategy"
      ...
      <div className="rounded-lg border border-border bg-card/50 p-6 backdrop-blur">
        ...
        <div className="space-y-4">
          <div>
            <p className="mb-2 block font-medium text-sm">Model Tier</p>
            <div className="flex gap-4">
              ...
              >
                ...
                <div className="text-muted-foreground text-sm">1 point per message</div>
              </button>
              <button
                type="button"
