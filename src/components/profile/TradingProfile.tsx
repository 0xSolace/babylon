  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center px-4 py-12 text-center">
        ...
        <h3 className="mb-2 font-semibold text-lg">Failed to Load Trading Data</h3>
      ...
      <div className="grid grid-cols-2 gap-4 p-4 lg:grid-cols-4">
        <div className="rounded-lg border border-border bg-card p-4">
          <div className="mb-2 flex items-center gap-2">
            ...
            <span className="font-medium text-muted-foreground text-xs">Balance</span>
          </div>
          <p className="font-bold text-2xl">{formatCurrency(stats?.balance || 0)}</p>
        </div>
        ...
        <div className="rounded-lg border border-border bg-card p-4">
          <div className="mb-2 flex items-center gap-2">
            ...
            <span className="font-medium text-muted-foreground text-xs">Lifetime P&L</span>
          </div>
          <p className={cn('font-bold text-2xl', isProfitable ? 'text-green-600' : 'text-red-600')}>
            {isProfitable ? '+' : ''}
        ...
        <div className="rounded-lg border border-border bg-card p-4">
          <div className="mb-2 flex items-center gap-2">
            ...
            <span className="font-medium text-muted-foreground text-xs">Points</span>
          </div>
          <p className="font-bold text-2xl">{(stats?.reputationPoints || 0).toLocaleString()}</p>
        </div>
        ...
        <div className="px-4">
          <div className="rounded-lg border border-border bg-card p-6">
            ...
            <div className="grid grid-cols-2 gap-4 lg:grid-cols-3">
              ...
              <div>
                <p className="mb-1 text-muted-foreground text-sm">Open Positions</p>
                <p className="font-bold text-xl">{portfolioPnL.totalPositions}</p>
              </div>
              ...
              <div>
                <p className="mb-1 text-muted-foreground text-sm">Predictions P&L</p>
                <p
                  className={cn(
                    'font-semibold text-lg',
              ...
              <div>
                <p className="mb-1 text-muted-foreground text-sm">Position Count</p>
                <p className="font-semibold text-lg">
                  {portfolioPnL.perpPositions} perps / {portfolioPnL.predictionPositions}{' '}
                  predictions
                </p>
              </div>
            </div>
                  ...
                  {perpPositions.map((position) => {
                    ...
                    return (
                      <button
                        ...
                        className="cursor-pointer rounded-lg border border-border bg-card p-4 text-left transition-all hover:border-primary/50"
                      >
                        ...
                        <div className="grid grid-cols-3 gap-4 text-sm">
                          <div>
                            <p className="mb-1 text-muted-foreground text-xs">Size</p>
                  ...
                  {predictionPositions.map((position) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="grid grid-cols-3 gap-4 text-sm">
                          <div>
                            <p className="mb-1 text-muted-foreground text-xs">Shares</p>
                            <p className="font-medium">{shares.toFixed(2)}</p>
                          </div>
                          <div>
                            <p className="mb-1 text-muted-foreground text-xs">Avg Price</p>
