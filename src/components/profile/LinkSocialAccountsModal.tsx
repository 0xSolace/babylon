...
type LinkSocialAccountsModalProps = {
  isOpen: boolean;
  onClose: () => void;
};
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm">
      <div className="w-full max-w-md rounded-xl border border-border bg-background">
        ...
        <div className="space-y-6 p-6">
          ...
          <div className="space-y-3">
            ...
            {user?.hasTwitter ? (
              <div className="flex items-center gap-2 rounded-lg border border-green-500/20 bg-green-500/10 p-3">
                ...
                <span className="font-medium text-sm">@{user.twitterUsername}</span>
                <a
              ...
              <div className="space-y-2">
                <div className="flex items-start gap-2 rounded-lg border border-blue-500/20 bg-blue-500/10 p-3">
                  ...
                  <p className="text-muted-foreground text-xs">
                    You&apos;ll be redirected to Twitter to authorize access. We&apos;ll verify your
                    account ownership.
                  </p>
                </div>
                <button
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              <svg className="h-5 w-5" viewBox="0 0 1000 1000" fill="currentColor">
            ...
            {user?.hasFarcaster ? (
              <div className="flex items-center gap-2 rounded-lg border border-green-500/20 bg-green-500/10 p-3">
                <Check className="h-4 w-4 text-green-500" />
                <span className="font-medium text-sm">@{user.farcasterUsername}</span>
                <a
              ...
              <div className="space-y-2">
                <div className="flex items-start gap-2 rounded-lg border border-purple-500/20 bg-purple-500/10 p-3">
                  ...
                  <p className="text-muted-foreground text-xs">
                    Sign in with Farcaster to verify your account. A popup will open for
                    authentication.
                  </p>
                </div>
                <button
          ...
          <div className="rounded-lg border border-primary/20 bg-primary/10 p-3">
            <div className="flex items-start gap-2">
              ...
              <p className="text-muted-foreground text-sm">
                OAuth authentication verifies your account ownership and earns you reputation
                points!
              </p>
            </div>
          </div>
