        ...
        <div className="flex-1 space-y-4">
          ...
          <div>
            <div className="mb-3 flex items-center gap-3">
              ...
              <h3 className="font-semibold text-foreground text-sm">Top Gainers</h3>
            </div>
                ...
                topGainers.map((mover) => (
                  ...
                  >
                    <div className="min-w-0 flex-1">
                      <div className="truncate font-semibold text-foreground">${mover.ticker}</div>
                      <div className="truncate text-muted-foreground text-xs">{mover.name}</div>
                    </div>
          ...
          <div>
            <div className="mb-3 flex items-center gap-3">
              ...
              <h3 className="font-semibold text-foreground text-sm">Top Losers</h3>
            </div>
            <div className="space-y-1.5">
              {topLosers.length > 0 ? (
                topLosers.map((mover) => (
