...
type CategoryPnLShareCardProps = {
      ...
      >
        ...
        >
          <svg
            ...
            fill="none"
            role="img"
            aria-labelledby="category-pnl-share-icon-title"
            xmlns="http://www.w3.org/2000/svg"
          >
            <title id="category-pnl-share-icon-title">{`Category badge for ${displayName}`}</title>
