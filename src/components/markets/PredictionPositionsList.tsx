...
import { type SellPredictionDetails, TradeConfirmationDialog } from './TradeConfirmationDialog';
...
type PredictionPositionsListProps = {
          ...
          <div key={position.id} className="rounded bg-muted/40 p-4">
            <div className="mb-3 flex items-center justify-between">
              ...
              <div className="text-right">
                ...
                <div
                  className={cn('text-xs', unrealizedPnL >= 0 ? 'text-green-600' : 'text-red-600')}
                >
                  {unrealizedPnL >= 0 ? '+' : ''}
            ...
            <p className="mb-3 font-medium text-foreground text-sm">{position.question}</p>
