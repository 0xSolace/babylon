  ...
  return (
    <div className="flex flex-1 flex-col rounded-lg bg-sidebar p-4">
      ...
      {loading ? (
        ...
        <div className="flex-1 text-muted-foreground text-sm">No trending posts at the moment.</div>
      ) : (
        <div className="flex-1 space-y-3">
          {posts.map((post) => {
            ...
            return (
              <button
                ...
                className="-mx-2 w-full cursor-pointer rounded-lg p-2 text-left transition-colors hover:bg-muted/50"
              ...
              >
                ...
                <div className="mb-1.5 flex items-center gap-2">
                  ...
                  <span className="ml-auto text-muted-foreground text-xs">{timeAgo}</span>
                </div>
