...
export function MarketsPanel() {
  ...
  return (
    <div className="flex flex-1 flex-col rounded-2xl bg-sidebar px-4 py-3">
      <h2 className="mb-3 text-left font-bold text-foreground text-lg">Markets</h2>
      {loading ? (
          ...
          {topMovers.length > 0 && (
            <div className="mb-4 pl-3">
              <div className="mb-2 flex items-center gap-1.5">
                ...
                <h3 className="font-semibold text-foreground text-sm">Top Movers (24h)</h3>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <div className="mb-2 flex items-center gap-1">
                    ...
                    <h4 className="font-semibold text-green-600 text-xs">Gainers</h4>
                  </div>
                  <div className="space-y-1.5">
                    {tokenGainers.map((token) => (
                      ...
                      >
                        <p className="font-bold text-foreground text-xs">${token.ticker}</p>
                ...
                <div>
                  <div className="mb-2 flex items-center gap-1">
                    ...
                    <h4 className="font-semibold text-red-600 text-xs">Losers</h4>
                  </div>
                  <div className="space-y-1.5">
