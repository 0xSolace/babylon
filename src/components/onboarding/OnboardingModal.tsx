  ...
  const renderProfileForm = () => (
    <form onSubmit={handleSubmit} className="space-y-6 p-6">
      <div className="space-y-2">
        <p className="block font-medium text-sm">Profile Banner</p>
  ...
  return (
    <>
      <button
        ...
        disabled={!canClose}
        aria-label={canClose ? 'Close onboarding modal' : 'Finish onboarding to close'}
        ...
        >
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                {user?.username && stage !== 'PROFILE' && (
                  <p className="mt-1 text-muted-foreground text-xs">@{user.username}</p>
                )}
              </div>
            </div>
            <button
          ...
          {stage === 'COMPLETED' ? (
            <div className="flex flex-col items-center gap-4 p-12">
              ...
              <p className="font-semibold text-lg">Onboarding complete! Enjoy Babylon 🎉</p>
              <button
                type="button"
            ...
            <div className="flex flex-col items-center gap-4 p-8 text-center">
              {isSubmitting ? (
                <>
                  ...
                  <p className="font-semibold text-lg">Finalising on-chain registration...</p>
                  ...
                  <p className="mt-2 text-muted-foreground/70 text-xs">
                    You can close this window and return later - your registration will continue in
                    the background.
                  </p>
                </>
              ) : error ? (
                  ...
                  <div className="mt-4 flex flex-col gap-2">
                    ...
                    {error.toLowerCase().includes('already registered') && (
                      <div className="max-w-md text-left text-muted-foreground text-xs">
                        <p className="mb-2">
                          Your wallet is already registered on the blockchain. This can happen if
                          you previously completed registration or if another account is using this
                          wallet.
                        </p>
                        <p>
                          You can skip this step and continue using the platform with your off-chain
                          profile.
                        </p>
                      </div>
                    )}
                ...
                <>
                  ...
                  <p className="font-semibold text-lg">Complete On-Chain Registration</p>
                  ...
                  {!isWalletReady && (
                    <p className="max-w-md text-amber-500 text-xs">
                      Preparing your Babylon smart wallet. We&apos;ll continue automatically once
                      it&apos;s ready.
                    </p>
                  )}
