...
export function Avatar({
  ...
  const imageSrc = currentImagePath ?? null;
  ...
  return (
    <div
      className={cn(
        ...
        hasImage && shouldFillParent ? 'relative' : '',
    ...
    >
      {imageSrc ? (
        <Image
          ...
          unoptimized
          {...(shouldFillParent
            ? { fill: true as const, sizes: '100%' }
            : { width: pixelSize, height: pixelSize, sizes: `${pixelSize}px` })}
        />
      ) : (
