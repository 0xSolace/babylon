 ...
 *   return <button type="button" onClick={() => connectTwitter()}>Connect Twitter</button>;
 * }
 *
 * return (
 *   <div>
 *     Connected as @{authStatus.screenName}
 *     <button type="button" onClick={disconnectTwitter}>Disconnect</button>
 *   </div>
 * );
 * ```
 */
