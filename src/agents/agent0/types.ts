 ...
 */
export type IAgentDiscoveryService = {
 ...
 */
export type Agent0RegistrationParams = {
  name: string;
  description: string;
  imageUrl?: string;
 ...
 */
export type Agent0RegistrationResult = {
  tokenId: number;
  txHash: string;
  metadataCID?: string;
};
 ...
 */
export type Agent0SearchFilters = {
  name?: string;
 ...
 */
export type Agent0SearchResult = {
  tokenId: number;
  name: string;
  walletAddress: string;
  metadataCID: string;
 ...
 */
export type Agent0AgentProfile = {
  tokenId: number;
  name: string;
  walletAddress: string;
  metadataCID: string;
 ...
 */
export type Agent0FeedbackParams = {
