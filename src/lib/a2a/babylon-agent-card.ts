...
export const babylonAgentCard: AgentCard = {
  ...
  skills: [
    ...
    },
    {
      ...
      examples: ['Search for active traders', 'Follow the top trader', 'Get my followers list'],
    ...
    },
    {
      ...
      examples: ['Show the top 10 traders', 'What topics are trending?', 'Get system statistics'],
      inputModes: ['text/plain'],
      outputModes: ['application/json'],
    },
    {
      ...
      examples: ['What is my balance?', 'Show all my positions', 'Transfer 100 points to user-123'],
      inputModes: ['text/plain', 'application/json'],
      outputModes: ['application/json'],
    },
    {
