...
const AGENT_CARD_SKILLS: Array<{
  ...
  },
  {
    ...
    examples: ['List all active markets', 'Buy 100 YES shares in market XYZ', 'Check my positions'],
  ...
  },
  {
    ...
    examples: ['Get my chats', 'Send a message', 'Create a trading strategy group'],
    inputModes: ['text/plain'],
    outputModes: ['application/json'],
  },
] as const;
