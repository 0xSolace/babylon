...
export async function storeTagsForPost(
  ...
  if (tagsToCreate.length > 0) {
    // Create all tags at once with skipDuplicates to handle race conditions
    // skipDuplicates ignores duplicates without error
    ...
    // Fetch all tags that should exist (either just created or already existed)
