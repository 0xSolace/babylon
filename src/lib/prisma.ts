...
const globalForPrisma = globalThis as unknown as {
  ...
  prismaWithRetry:
    | ReturnType<typeof createRetryProxy<PrismaClient>>
    | undefined;
};
...
export const prisma: PrismaClient = (globalForPrisma.prismaWithRetry ??
  createRetryProxy(basePrismaClient, {
    maxRetries: 5,
    initialDelayMs: 100,
    maxDelayMs: 5000,
    jitter: true,
...
if (process.env.NODE_ENV !== 'production') {
  globalForPrisma.prismaWithRetry = prisma as ReturnType<
