 ...
 * SSE channel schema
 */
export const SSEChannelSchema = z.enum(['feed', 'markets', 'breaking-news', 'upcoming-events']);
...
export const MarkNotificationsReadSchema = z
  ...
  .refine(
    (data) =>
      data.markAllAsRead === true || (data.notificationIds && data.notificationIds.length > 0),
    {
