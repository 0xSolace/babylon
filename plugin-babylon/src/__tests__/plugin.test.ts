...
describe('Plugin Configuration', () => {
  it('should have correct plugin metadata', () => {
    ...
    expect(predictionMarketsPlugin.evaluators?.length).toBeGreaterThanOrEqual(
      2
    );
...
describe('BUY_SHARES Action', () => {
  ...
  it('should validate buy intent messages', async () => {
    ...
    runtime.getService = mock(
      () => mockBabylonService as unknown as BabylonClientService | null
    );
