...
import type { DiscoverableGame } from '@babylon/agents'
import { GameDiscoveryService } from '@babylon/agents'
...
export class BabylonDiscoveryService extends Service {
  ...
  static override async start(
    ...
    logger.info(
      'Starting BabylonDiscoveryService',
      undefined,
  ...
  async initialize(): Promise<void> {
    if (process.env.AGENT0_ENABLED !== 'true') {
      this.runtime.logger.info(
        'Agent0 integration disabled, discovery service unavailable',
        undefined,
        'BabylonDiscoveryService',
      )
      return
    ...
    this.runtime.logger.info(
      '✅ BabylonDiscoveryService initialized',
      undefined,
      'BabylonDiscoveryService',
    )
  }
  ...
  override async stop(): Promise<void> {
    this.runtime.logger.info(
      '✅ BabylonDiscoveryService stopped',
      undefined,
      'BabylonDiscoveryService',
    )
  }
  ...
  static override async stop(runtime: IAgentRuntime): Promise<void> {
    logger.info(
      'Stopping BabylonDiscoveryService',
      undefined,
      'BabylonDiscoveryService',
    )
    const service = runtime.getService<BabylonDiscoveryService>(
      BabylonDiscoveryService.serviceType,
    )
    await service?.stop()
  }
}
