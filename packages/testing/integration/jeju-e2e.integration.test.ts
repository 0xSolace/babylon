...
// Response schemas for type-safe parsing
const HealthSchema = z.object({ status: z.string() })
const ServicesSchema = z.object({ services: z.array(z.string()) })
const CidSchema = z.object({ cid: z.string() })
const EncryptedPayloadSchema = z.object({ encryptedPayload: z.string() })
const DecryptedDataSchema = z.object({ data: z.string() })
...
describe('Jeju Gateway', () => {
  it('should be healthy', async () => {
    ...
    const data = HealthSchema.parse(await responseJson(response))
  ...
  it('should list available services', async () => {
    ...
    const data = ServicesSchema.parse(await responseJson(response))
...
describe('Jeju Storage', () => {
  ...
  it('should upload files', async () => {
    ...
    const result = CidSchema.parse(await responseJson(response))
...
describe('Jeju KMS', () => {
  ...
  it('should encrypt and decrypt data', async () => {
    ...
    const encrypted = EncryptedPayloadSchema.parse(
      await responseJson(encryptResponse),
    )
    ...
    const decrypted = DecryptedDataSchema.parse(
      await responseJson(decryptResponse),
    )
...
describe('Jeju Inference', () => {
  it('should list available models', async () => {
    ...
    const data = ModelsSchema.parse(await responseJson(response))
  ...
  it('should perform chat completion', async () => {
    ...
    const result = CompletionSchema.parse(await responseJson(response))
...
describe('OAuth3 Wallet Auth', () => {
  ...
  it('should create auth session via gateway', async () => {
    ...
    const session = SessionSchema.parse(await responseJson(response))
...
describe('Compute Triggers', () => {
  ...
  it('should register compute triggers via gateway', async () => {
    ...
    const result = IdSchema.parse(await responseJson(response))
