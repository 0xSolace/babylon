...
describe('Cache Boundary Conditions', () => {
  describe('Key Validation', () => {
    ...
    it('should handle null bytes in keys', () => {
      ...
      // biome-ignore lint/suspicious/noControlCharactersInRegex: Testing null byte sanitization
  ...
  describe('Error Handling', () => {
    ...
    it('should handle timeout gracefully', async () => {
      ...
      await expect(withTimeout(slowCache.get(), 100)).rejects.toThrow('Timeout')
    })
