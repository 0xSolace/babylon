...
// Create a testable version of the service that uses the protected setTestMappings method
class TestableCharacterMappingService extends CharacterMappingService {
  setMockMappings(
    ...
    // Use the protected method to set test mappings without casting
    this.setTestMappings(characters, organizations)
  }
}
