...
// These replace unsafe `as` casts with runtime validation
// ============================================================================

/** Schema for PlaceBet API response - uses catchall for JsonValue compatibility */
export const PlaceBetResponseSchema = z.object({}).catchall(JsonValueSchema)

/** Schema for ClosePosition API response - uses catchall for JsonValue compatibility */
export const ClosePositionResponseSchema = z
  .object({})
  .catchall(JsonValueSchema)

/** Schema for BuyShares API response - uses catchall for JsonValue compatibility */
export const BuySharesResponseSchema = z.object({}).catchall(JsonValueSchema)

/** Schema for SellShares API response - uses catchall for JsonValue compatibility */
export const SellSharesResponseSchema = z.object({}).catchall(JsonValueSchema)

/** Schema for OpenPosition API response - uses catchall for JsonValue compatibility */
export const OpenPositionResponseSchema = z.object({}).catchall(JsonValueSchema)

/** Schema for GetTrades API response */
...
/** Schema for GetTradeHistory API response */
export const GetTradeHistoryResponseSchema = z.object({
  trades: z.array(
    z.object({
      id: z.string(),
      marketId: z.string(),
...
/** Schema for GetLeaderboard API response */
...
/** Schema for GetReputation API response */
...
/** Schema for GetReputationBreakdown API response */
export const GetReputationBreakdownResponseSchema = z.object({
  userId: z.string(),
  trustScore: z.number(),
  accuracyScore: z.number(),
  breakdown: z.object({
    marketPerformance: z.number(),
    socialActivity: z.number(),
    userFeedback: z.number(),
  }),
})

/** Schema for PaymentRequest API response */
...
/** Schema for PaymentReceipt API response */
...
/** Schema for AppealBan API response */
export const AppealBanResponseSchema = z.object({
  success: z.boolean(),
  message: z.string(),
  appealStatus: z.string(),
})

/** Schema for GetFavoritePosts API response */
export const GetFavoritePostsResponseSchema = z.object({
  posts: z.array(
    z.object({
      id: z.string(),
      content: z.string(),
...
/** Schema for TransferPoints API response */
