 ...
 *
 * BACKUP FALLBACK: Markov chain price generation.
 * Primary price movement is now driven by NPC trading activity (LLM-generated).
 *
...
export class PriceEngine {
  ...
  private initializeMarkovState(): MarkovChainState {
    const trends: Array<'bullish' | 'bearish' | 'neutral'> = [
      'bullish',
      'bearish',
      'neutral',
    ]
