...
export interface PredictionResolutionEvent {
  ...
  totalPayout: number
  timestamp: string
  /** URL to proof of resolution, null if not available */
  resolutionProofUrl?: string | null
  /** Description of the resolution, null if not available */
...
export class PredictionMarketService {
  ...
  static async getHistory(
    ...
    // Use repository pattern for proper typing
    return db.predictionPriceHistory.findMany({
      where: { marketId },
