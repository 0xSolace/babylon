 ...
 * Storage Utility
 *
 * Provides IPFS-based storage for models and datasets as an alternative
 * to centralized services like HuggingFace.
 *
 * Storage backends:
...
function isIPFSUploadResult(value: unknown): value is IPFSUploadResult {
  return (
    isObject(value) &&
    isString(value.cid) &&
    isString(value.url) &&
