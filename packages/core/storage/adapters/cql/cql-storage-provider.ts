/**
 * CQL Storage Provider
 *
 * For production use with CovenantSQL (decentralized database).
 *
...
const NOT_IMPLEMENTED_MSG =
  'CQLStorageProvider not yet fully implemented. ' +
...
export class CQLStorageProvider implements IStorageProvider {
  readonly mode: StorageMode = 'cql';
  ...
  async initialize(): Promise<void> {
    // In CQL mode, the database is managed by @babylon/db
