import type { BroadcastPort, CachePort, ClockPort, FeeConfig, WalletPort } from '../shared/common';
...
export interface PerpDbPort {
    ...
    updateMarketStats(ticker: string, updates: Partial<Pick<PerpMarketRecord, 'currentPrice' | 'price24hAgo' | 'change24h' | 'changePercent24h' | 'high24h' | 'low24h' | 'volume24h' | 'openInterest' | 'fundingRate' | 'markPrice' | 'indexPrice'>>): Promise<void>;
}
