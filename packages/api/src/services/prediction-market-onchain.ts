 ...
 *
 * @description Handles on-chain prediction market transactions on Ethereum
 * (Sepolia/Mainnet). Interacts with the PredictionMarketFacet through a Diamond proxy
