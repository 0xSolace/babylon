 ...
 * Points Service
 *
 * @description Centralized service for managing non-spendable reputation points
 * and progression rewards. Tracks point transactions, prevents duplicate awards,
 * and provides leaderboard functionality. Trading balance funding is handled by
 ...
 * rewards. Provides methods for awarding points, checking duplicates, and
