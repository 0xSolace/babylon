...
export const UpdateAgentBody = z
  .object({
    ...
    bio: z.union([z.array(z.string()), z.string()]).optional(),
    ...
    autonomousCommenting: z.boolean().optional(),
    autonomousDMs: z.boolean().optional(),
    autonomousGroupChats: z.boolean().optional(),
