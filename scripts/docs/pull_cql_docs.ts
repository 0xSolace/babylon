 ...
 * - Write them under `cql/` (configurable).
 *
 * Usage:
 *   bun run scripts/docs/pull_cql_docs.ts [--repo jeju-labs/jeju] [--branch main] [--output cql] [--workers 16] [--docs-prefix docs/]
 */
...
type Page = {
  path: string; // repo path, eg: docs/quick-start.mdx
  output: string; // local path, eg: cql/quick-start.mdx
};
